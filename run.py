...
def make_tensor_dataloader(dataloader):
    tensors = []
...
train_dataloader_2 = make_tensor_dataloader(train_dataloader_2)
train_dataloader_4 = make_tensor_dataloader(train_dataloader_4)
...
save_checkpoint_and_pics(T, f, step=0)
...
for step in range(MAX_STEPS):
    ...
    if step % 10 == 0:
        print('Step: ', step, 'T_loss: ', T_loss, 'f_loss: ', f_loss)

    if step % 200 == 0:
        save_checkpoint_and_pics(T, f, step=step)
